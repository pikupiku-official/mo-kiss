...
CHARA_TORSO_CROSSFADE_DEFAULT_MS = 300
...
# 史実天気表示設定
WEATHER_DISPLAY_X = 22              # 天気表示のX座標（仮想画面基準）
WEATHER_DISPLAY_Y = 100             # 天気表示のY座標（仮想画面基準）
WEATHER_FONT_SIZE = 35              # 天気フォントサイズ（仮想画面基準のピクセル値）
WEATHER_TEXT_COLOR = (255, 255, 255)  # 天気テキストの色
...
try:
    ...
    gender_file_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'character_gender.json')
