...
[se se="高校の教室" volume="0.5" frequency="1" block="false"]
	//純一//
	「さようならー。」
	「（ふう。今日も一日疲れたな・・・）」
	「（特に予定もないから今日はまっすぐ帰ろう。）」
...
[fadein time="1.0"]
[se se="公園1" volume="0.5" frequency="1" block="false"]
	//純一//
	「（まっすぐ帰るつもりだったけど、なんとなく駅前の商店街まで来てしまった。）」
	「（いつ来てもここの景色はずっと変わらないな。）」

[se se="自転車が近づいて止まる" volume="0.5" frequency="1" block="false"]
	//純一//
	「ん？なんだ？」
...
　　　　	「スパゲッティ食べてた。喫茶店で。」
　　　　	「小学生のくせに大盛り。」
[chara_shift name="直樹" torso="NOK_T00_ARM01_CLO00" eye="NOK_F00_EYE_01" mouth="NOK_F00_MOU_12" brow="NOK_F00_BRO_03" fade="0.15"]
	//直樹//
	「そうそう！」
[chara_shift name="直樹" torso="NOK_T00_ARM03_CLO00" eye="NOK_F00_EYE_09" mouth="NOK_F00_MOU_01" brow="NOK_F00_BRO_03" fade="0.15"]
	//直樹//
...
[chara_shift name="直樹" torso="NOK_T00_ARM02_CLO00" eye="NOK_F00_EYE_02" mouth="NOK_F00_MOU_04" brow="NOK_F00_BRO_02" fade="0.15"]
	//直樹//
	「どうだか。」
[chara_shift name="直樹" torso="NOK_T00_ARM03_CLO00" eye="NOK_F00_EYE_02" mouth="NOK_F00_MOU_01" brow="NOK_F00_BRO_05" fade="0.15"]
	//直樹//
...
[chara_shift name="直樹" torso="NOK_T00_ARM03_CLO00" eye="NOK_F00_EYE_03" mouth="NOK_F00_MOU_02" brow="NOK_F00_BRO_01" fade="0.15"]
	...
	//純一//
　　　　	「おっかないですね、原因は何ですか。」
[chara_shift name="直樹" torso="NOK_T00_ARM03_CLO00" eye="NOK_F00_EYE_02" mouth="NOK_F00_MOU_02" brow="NOK_F00_BRO_03" fade="0.15"]
	//直樹//
	「それが一切判らない。」
[chara_shift name="直樹" torso="NOK_T00_ARM01_CLO00" eye="NOK_F00_EYE_01" mouth="NOK_F00_MOU_06" brow="NOK_F00_BRO_05" fade="0.15"]
	//直樹//
	「だが、よく判らないモノはワタシらの出番。」
...
[se se="自転車ﾁﾘﾝ" volume="0.5" frequency="1" block="false"]
[se se="自転車が遠ざかる" volume="0.5" frequency="1" block="false"]
	//純一//
	「（……）」
